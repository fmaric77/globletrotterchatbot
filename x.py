...
def query_athena_tool(query: str) -> str:
    """Execute a query in Athena and return only the query results as a list regardless of its size.
    ...
    Always return only the result of the query as a list regardless of its size, not an explanation or the query itself.
